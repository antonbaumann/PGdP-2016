...
public class SymmetricStack implements Iterable<Integer> {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 30; ++i) {
            if (i % 2 == 0)
                s.append(randomGen.nextInt(100));
            else
                s.prepend(randomGen.nextInt(100));
        }
    ...
    public Iterator<Integer> iterator() {
        return new Iterator<Integer>() {
            int pos = 0;
            int nrElements = getNumberOfElements();

            @Override
            public boolean hasNext() {
                return pos < nrElements;
            }
            ...
            public Integer next() {
                ...
                pos++;
                return data[(first + pos - 1) % data.length];
            }
        };
    }
