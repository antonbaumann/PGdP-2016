public class LustigeSieben extends MiniJava{
    public static void main(String[] args){
        //Initialisierung
        int guthaben=100;
        write("Lass uns spielen! "
                + "Du hast "+guthaben+" Chips zur Verfuegung.");
        ...
        while(guthaben>0){
            ...
            if(einsatz==0){ //Beenden des Spiels
                write("Du gewinnst mit "+guthaben+" Chips. "
                        + "Herzlichen Glueckwunsch.");
                return;
            }
            while(einsatz<0 || einsatz>guthaben){ //Einsatz zu hoch oder zu klein
                if(einsatz>guthaben){
                	einsatz=readInt("Soviele Chips hast Du nicht mehr. "
                    + "Dein Guthaben betraegt "+guthaben+". "
                    + "Was ist dein Einsatz?");
                }
                if(einsatz<0){
                	einsatz=readInt("Ungueltige Eingabe."
                    + "Dein Guthaben betraegt "+guthaben+". "
                    + "Was ist dein Einsatz?");
                }
                if(einsatz==0){ //Beenden des Spiels
            ...
            while(feld>12||feld<2){ // Feld existiert nicht
                feld=readInt("Es gibt nur die Felder 2 bis 12. "
                    + "Auf welches Feld willst Du setzen?");
                if(feld==0){ // Beenden des Spiels
                    write("Du gewinnst mit "+guthaben+" Chips. "
                            + "Herzlichen Glueckwunsch.");
                    return;
            ...
            // Wuerfeln
            write("Rien ne va plus. "
                    + "Du hast "+einsatz+" Chips auf die "
                    + feld +" gesetzt.");
            int wurf = dice()+dice();
            ...
            if(wurf==feld){
                ...
                if(wurf == 7) gewinn = gewinn + einsatz; // 1. Fall
            }
            else{
            ...
            write("Du bekommst "+gewinn+" Chips. "
                    + "Dein Guthaben betraegt nun: "+guthaben
                    + " Chips.");
            if(guthaben==0){
